import React, { useSnackbar } from "react";
...
class Details extends React.Component {
    ...
    render() {
        const { restaurent, menuItemsModalIsOpen, restaurentModelData, totalPrice, promenuItemModalIsopen } = this.state;
        console.log(totalPrice);
        return (
            <div>
                <div>
                        ...
                        <div className="row">
                            ...
                            <div className="row">
                                <div className="col-md-6 offset-md-3">
                                    ...
                                    <Button className="paynow" color="error" onClick={() => this.handleProModal()}>pay now</Button>
                                    <ToastContainer />
                                </div>
                                <Modal
