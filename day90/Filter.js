...
class Filter extends React.Component {
  ...
  //   searchFilter: {
  //     mealtype_id: Number(mealtype),
  //     location_id: Number(locationsData),
  //   }
  ...
  // handleNavigation = (meal_type) => {
  //   const { locationsData } = this.props;
  //   sessionStorage.setItem("location_id", locationsData)
  //   if (locationsData) {
  //     this.props.history.push(`/filter?mealtype=${meal_type}&location_id=${locationsData}`);
  //   } else {
  //     console.log(null);
  //   }
  // }
